...
const AnalysisSchema = new mongoose_1.Schema({
    resumeId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Resume', required: true, index: true },
    jobDescriptionId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'JobDescription' },
