                                ...
                                {feedback?.interviewQuestions && feedback.interviewQuestions.length > 0 ? (
                                    <ul className="space-y-6">
                                        {feedback.interviewQuestions.map((q, i) => (
                                            <li key={i} className="flex flex-col gap-2 items-start p-4 bg-gray-50 rounded-xl">
                                                <div className="flex gap-4 w-full">
                                                    ...
                                                    <div className="flex flex-col w-full">
                                                        <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">{q.category}</span>
                                                        <p className="text-gray-800 font-medium text-lg pt-1">{q.question}</p>
                                                        <p className="text-sm text-gray-600 mt-2 italic bg-blue-50 p-2 rounded-lg">Why: {q.rationale}</p>
                                                    </div>
                                                </div>
                                            </li>
                                        ))}
